...
court. C'est une chose de jouer les curateur•ice•s de sons. S'en est une autre
...
Flowers  principalement pour les magnifique 30 secondes de chant où l'on entend
...
place-on un morceau de ce genre dans un set ? Ça me semble pas si trivial que
ça.
