...
export function Paragraph({ children, centered } : { children: React.ReactNode, centered?: boolean }) {
  return <p className={classnames(styles.paragraph, { [styles.centered]: centered })}>{children}</p>
}
