...
export function Play({
  ...
  return (
    <button className={classnames(
      ...
      <VisuallyHidden>
        Lancer la lecture de {trackName}
      </VisuallyHidden>
      <svg className={styles.svg} viewBox="0 0 526 526" xmlns="http://www.w3.org/2000/svg">
...
export function Pause({
  ...
  return (
    <button className={classnames(
      ...
      <VisuallyHidden>
        Suspendre la lecture de {trackName}
      </VisuallyHidden>
      <svg className={styles.svg} viewBox="0 0 526 526" xmlns="http://www.w3.org/2000/svg">
...
export function Next({
  ...
  return (
    <button className={classnames(styles.commandButton, styles.small)} onClick={onClick}>
      <VisuallyHidden>
        Lancer la lecture de {trackName}
      </VisuallyHidden>
      <svg className={styles.svg} viewBox="0 0 526 526" xmlns="http://www.w3.org/2000/svg">
...
const AutoPlayOnIcon = () => (
  <svg className={styles.svg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 526 526">
    <g clipPath="url(#a)">
...
export function AutoPlay({
  ...
  return (
    <button aria-pressed={status === 'on'} className={classnames(styles.commandButton, styles.medium)} onClick={onClick}>
      <VisuallyHidden>
        {status === 'on' ? 'Désactiver la lecture automatique' : 'Activer la lecture automatique'}
      </VisuallyHidden>
...
function useRotate() {
  ...
  const animate = () => {
    ...
    setQuarter(quarter => (quarter + 1) % 4)
...
export function Loading({
  ...
  return (
    <svg className={classnames(styles.svgLoading, {
      ...
      <path d="m117 113 299 299H117V113Z" style={{ transform: `rotate(${deg}deg)`, transformOrigin: 'center center' }}/>
    </svg>
  )
}
