...
export function TrackPlayer({ embedableLink }: {
  embedableLink: EmbedableLink.EmbedableLink
}): JSX.Element {
  return pipe(
    embedableLink,
    EmbedableLink.fold({
      Youtube: link => <Youtube.Player trackId={EmbedableLink.trackId(link)} />,
      Soundcloud: link => <Soundcloud.Player href={EmbedableLink.href(link)} />,
